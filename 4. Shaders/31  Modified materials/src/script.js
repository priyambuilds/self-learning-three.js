 ...
 * Models
 */
// First log the current working path
...
gltfLoader.load(
    ...
    (error) =>
    {
        ...
        console.error('Attempted to load from:', new URL('/static/models/LeePerrySmith/LeePerrySmith.glb', window.location.href).href)
    }
)
